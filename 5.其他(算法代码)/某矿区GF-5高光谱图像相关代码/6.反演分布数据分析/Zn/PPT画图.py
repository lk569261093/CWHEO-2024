...
# 定义直方图的颜色
hist_color = 'skyblue'  # 与第二段代码中的 hist_color 一致
...
# 绘制直方图
ax_hist.hist(valid_data, bins=n_bins, range=(30, 160), color=hist_color, edgecolor='black')

# **设置直方图的横坐标范围为 30 到 160**
ax_hist.set_xlim(30, 160)

# **设置横坐标刻度为 [30, 40, 60, 80, 100, 120, 140, 160]**
ax_hist.set_xticks([30, 40, 60, 80, 100, 120, 140, 160])
